        ...
        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class=" d-md-flex justify-content-md-end">
                            <a class="btn btn-primary text-primary" type="button" data-bs-toggle="modal" data-bs-target="#createModal"><i
            ...
            <form action="/suppliers" type="get">
                <div class="input-group">
                    ...
                    <button class="btn btn-outline-primary" title="Reload" type="submit"><i class="fa fa-sync-alt"></i></button>
                </div>
            </form>
            {{-- ---end search------------- --}}
                                ...
                                <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <form action="{{ route('suppliers.destroy', $supplier->sup_id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" name="sup_name" id="sup_name" class="form-control" placeholder="Enter Name"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                            <label for="nameWithTitle" class="form-label">Supplier Detail</label>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="nameWithTitle" class="form-label">Supplier Contact</label>
                            <input type="text" id="nameWithTitle" class="form-control"
