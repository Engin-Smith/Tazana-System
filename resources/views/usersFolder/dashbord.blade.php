...
<head>
  ...
  <link href="{{asset('assets1/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('assets1/css/soft-ui-dashboard.css?v=1.0.7')}}" rel="stylesheet" />
...
<body class="g-sidenav-show bg-gray-100">
              ...
              <ul class="dropdown-menu dropdown-menu-end px-2 py-3 ms-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  ...
                  onclick="event.preventDefault();
                    ...
                    <span class="align-middle"><div class="d-flex py-1">
                      <div class="my-auto">
                        {{-- <img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3"> --}}
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Clicking to </span> Logout
                        </h6>
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="{{asset('assets1/img/bruce-mars.jpg')}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
              ...
              <div class="card h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    ...
                    <!-- Other list items for 'Account' settings -->
                  </ul>
                  ...
                  <ul class="list-group">
                    ...
                    <!-- Other list items for 'Application' settings -->
                  </ul>
                </div>
              </div>
            </div>
  ...
  <script src="{{asset('assets1/js/soft-ui-dashboard.min.js?v=1.0.7')}}"></script>
</body>
